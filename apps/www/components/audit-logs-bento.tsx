...
export function AuditLogsBento() {
  return (
    <div className="relative group no-scrollbar overflow-hidden w-full xl:mt-10  border-[.75px] h-[520px] rounded-[32px] border-[#ffffff]/10 flex overflow-x-hidden bg-linear-to-br from-white/10 to-black">
      <AuditLogs className=" sm:h-[400px] w-full sm:ml-[40px]" />
      <div className="absolute inset-0 w-full h-full duration-500 pointer-events-none bg-linear-to-tr from-black via-black/40 to-black/0 group-hover:opacity-0 group-hover:backdrop-blur-0" />
