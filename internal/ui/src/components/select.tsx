    ...
    variants: {
      variant: {
        ...
        success: [
          ...
          "focus:border-success-8 focus:ring-4 focus:ring-success-2 focus-visible:outline-none",
        ],
        warning: [
          "border border-warning-9 hover:border-warning-10 bg-gray-2 dark:bg-black",
          "focus:border-warning-8 focus:ring-4 focus:ring-warning-2 focus-visible:outline-none",
        ],
        error: [
          "border border-error-9 hover:border-error-10 bg-gray-2 dark:bg-black",
          "focus:border-error-8 focus:ring-4 focus:ring-error-2 focus-visible:outline-none",
        ],
      },
    },
    defaultVariants: {
